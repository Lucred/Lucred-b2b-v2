                            ...
                            <div className='bg-[#fff] h-[800px]'>
                                <div className="w-[100%]  py-[3%] px-[4%] my-[2%] rounded-md">
                                    ...
                                    <div className='my-[3%]'>
                                        ...
                                        <div className='text-[0.9rem] font-[400] text-[#110077]'>{currentEmployee.workData?.[0]?.jobTitle}</div>
                                    </div>
                                    <div className='my-[3%]'>
                                    ...
                                    <div className='my-[3%]'>
                                        ...
                                        <div className='text-[0.9rem] font-[400] text-[#110077]'>₦{currentEmployee.workData?.[0]?.workSalary}</div>
                                    </div>
                                    <div className='my-[3%]'>
                                        <div className='text-[0.9rem] font-[400] pb-[2px]'>Status:</div>
                                        <div className='text-[0.9rem] font-[400] text-[#110077]'>{currentEmployee.workData?.[0]?.employmentStatus}</div>
                                    </div>
                                    <div className='my-[3%]'>
